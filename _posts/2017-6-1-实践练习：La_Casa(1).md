...
/* 子元素使用，排列方式 */
/* align-items 和 align-self更像是 flex中的 text-align/vertical-align实现, 是在y轴方向上的对齐排列，使用stretch可以得到上下/左右对齐的效果，但是justify-content和align-items不是有冲突了吗 */
...
```
[有关对Flexbox属性尝试的demo](/demo/CSS3_demo/Flexbox.html)
